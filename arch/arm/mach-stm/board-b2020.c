/*
 * arch/arm/mach-stm/board-b2020.c for ES4
 *
...
#if 1
#if 1
#define B2020_GMII1_PHY_NOT_RESET stm_gpio(3, 6)
#else
...
static int b2020_gmii1_reset(void *bus)
{
    ...
    mdelay(100); /* 100 miliseconds is enough for everyone ;-) */
    gpio_set_value(B2020_GMII1_PHY_NOT_RESET, 1);
    mdelay(200); /* 200 miliseconds is enough for everyone ;-) */
#else
	gpio_set_value(B2020_GMII1_PHY_NOT_RESET, 1);
	gpio_set_value(B2020_GMII1_PHY_NOT_RESET, 0);
